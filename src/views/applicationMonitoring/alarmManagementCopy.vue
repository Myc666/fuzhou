<template>
    <div style="background: #fff;border-radius: 8px;position: relative;height: 100vh;">
      <div class="top-tabs">
          ...
          <div v-if="tableData.length">
            <div class="table-sty">
              <div v-for="item in tableData" :key="item.id" class="item-sty">
                ...
                <div style="padding: 0px 10px 10px 0px; text-align: right;color: #2099fa; cursor: pointer;" @click="deleteFun(item.id)">删除</div>
              </div>
            </div>
          </div>
