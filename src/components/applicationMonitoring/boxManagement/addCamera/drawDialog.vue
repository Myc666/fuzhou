  ...
  <div>
      <el-dialog
        ...
        <span slot="footer" class="dialog-footer">
          ...
          <el-button type="primary" v-if="nameEn != 'person_tracker'&&nameEn != 'peopleTrack'" @click="newDraw">绘制下一区域</el-button>
          <el-button type="primary" v-if="nameEn == 'person_tracker' || nameEn == 'peopleTrack'" @click="LineDraw">绘制线</el-button>
  ...
  methods: {
    saveList(list){
      ...
      async saveDraw(){
          ...
          Arr.forEach((i) => {
              if((this.nameEn == "person_tracker" || this.nameEn == 'peopleTrack') && i.pointList.length==2){
